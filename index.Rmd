...
```{r cors-work, fig.cap="Correlations of Work Expectations", layout = "l-page", fig.width=10, fig.height=10}
...
```{r cors-crowdwork, fig.cap="Correlations of Crowdwork Expectations", layout = "l-page", fig.width=10, fig.height=10}
...
```{r loaplot-work, fig.cap="Loadings for Work Condition", fig.height=10, fig.width=10, layout = "l-page"}
...
```{r loaplot-crowd, fig.cap="Loadings for Crowd Condition", fig.height=10, fig.width=10, layout = "l-page"}
