...
```{r paran, cache=TRUE, include = FALSE}
...
```{r loaplot, fig.cap=c("Loadings for Work Condition", "Loadings for Crowd Condition")}
pensieve:::plot.QLoas(unclass(pcares$work$loadings), by = "people")
...
A second, bipolar factor loads only on 
