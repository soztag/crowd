...
```{r export, cache=FALSE, eval=FALSE, include = FALSE}
# this was for sabine
objs <- list(
  crowddata = crowddata, 
  quest = quest, 
  exp_crowd = crowddata$exp_crowd, 
  exp_work = crowddata$exp_work
)
purrr::iwalk(
  .x = objs,
  .f = function(x, y) {
...
Dies hängt mitunter damit zusammen, dass für die meisten der Befragten Crowdwork als Einkommensquelle fungiert. 
