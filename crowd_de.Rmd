...
```{r crowd, fig.cap="Erwartungen an Crowdarbeit", fig.width=12, fig.height=10, out.width="1\\linewidth"}
interesting <- NULL
...
```{r diff, fig.cap="Erwartungen an Reguläre Beschäftigung - Crowdwork", fig.width=12, fig.height=10, out.width="1\\linewidth"}
